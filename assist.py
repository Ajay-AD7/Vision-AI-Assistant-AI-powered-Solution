...
os.environ["Your_Api_key"] = GEMINI_API_KEY
...
st.title(" VISION AI ASSISTANT 🤖 - Visually Impaired individuals")
st.sidebar.title("Features of AI Assistant 🤖")
st.sidebar.markdown("""
...
**Interaction:** Triggered via the "📝 Image2Text" button.\n
...
ocr_button = col1.button("📝 Image2Text")
tts_button = col2.button("📝 Text-2-Audio 🔊")
